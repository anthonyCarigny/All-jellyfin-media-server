...
English installer:
```bash
wget https://raw.githubusercontent.com/anthonyCarigny/All-jellyfin-media-server/Main/setup.sh -O setup.sh
chmod +x setup.sh
./setup.sh
```
...
# SERVER_COUNTRIES=Belgium  # Choose the server region (Belgium here)
